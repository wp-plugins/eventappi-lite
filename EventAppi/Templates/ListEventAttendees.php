<div id="eventappi-wrapper" class="wrap">
    ...
    <table class="wp-list-table widefat fixed posts">
        ...
        <tr>
            ...
            <th scope="col" class="manage-column column-title"><span><?php _e('Additional Attendee Data', EVENTAPPI_PLUGIN_NAME); ?></span></th>
        ...
        foreach ($data['attendees'] as $index => $attendee) : ?>
            <tr class="hentry <?php
                ...
                <td>
                    <?php echo ($attendee->isClaimed == '1') ? __('CLAIMED', EVENTAPPI_PLUGIN_NAME) : $attendee->assignedTo; ?>
                </td>
                <td>
                    <?php
                    $extraInfo = '';
                ...
                <td>
                    <?php
                    $checkInState = ($attendee->isCheckedIn === '1') ? 'Out' : 'In';
                    $checkInStateText = ($attendee->isCheckedIn === '1') ? __('Check Out', EVENTAPPI_PLUGIN_NAME) : __('Check In', EVENTAPPI_PLUGIN_NAME);
                    ?>
